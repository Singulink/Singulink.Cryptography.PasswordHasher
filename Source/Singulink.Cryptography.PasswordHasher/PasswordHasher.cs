...
namespace Singulink.Cryptography
{
    ...
    public sealed class PasswordHasher
    {
        ...
        /// iterations has changed then the resulting hash will return true when passed into the <see cref="RequiresRehash(string, string)"/> method, which
        /// should be tested on successful user login so that a new hash without chaining can be generated by calling the <see cref="Hash(string)"/>
        /// method.</para>
        /// </remarks>
